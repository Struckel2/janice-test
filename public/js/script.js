...
${currentActionPlanData.conteudo}`;
  ...
  function preencherFormularioComMockup(configuracoes) {
    console.log('📝 [PREENCHER] Preenchendo formulário com:', configuracoes);
    ...
    if (configuracoes.configuracao) {
      ...
      if (estiloSelect && config.estilo) {
        estiloSelect.value = config.estilo;
      }
    ...
    // Preencher configurações técnicas se existirem
    ...
    console.log('✅ [PREENCHER] Formulário preenchido com sucesso');
  }
